    ...
    <>
      <Card sectioned>
        <div className="flex items-center justify-between">
          <div>
            <Text variant="headingMd" as="h2">Connect your Shopify store</Text>
      ...
      >
        <Modal.Section>
          {errorMessage && (
            <Banner status="critical" onDismiss={() => setErrorMessage('')} className="mb-4">
              <p>{errorMessage}</p>
            </Banner>
          )}

          <Text as="p" variant="bodyMd" className="mb-4">
            To connect your Shopify store, you'll need your shop domain and an Admin API access token.
          </Text>
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-md">
            <Text as="h3" variant="headingSm" className="mb-2">How to get your access token</Text>
            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
              <li>Go to your Shopify admin</li>
              <li>Navigate to Apps &gt; App and sales channel settings</li>
              <li>Click "Develop apps for your store"</li>
              <li>Create a new app or select an existing one</li>
              <li>Go to API credentials and create an Admin API access token</li>
              <li>Ensure it has the necessary permissions (read_products, read_orders, etc.)</li>
