...
export const useNetSuiteTransactions = (type?: string, startDate?: string, endDate?: string, limit = 20, offset = 0) => {
  return useQuery({
...
export const useNetSuiteFinancialData = (period: string, subsidiaryId?: string) => {
  return useQuery({
