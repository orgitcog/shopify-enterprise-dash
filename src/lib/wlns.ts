...
export const createWellnessCenter = async (
  center: Omit<WellnessCenter, "id" | "created_at">,
) => {
  try {
    const { data, error } = await supabase
      .from("wlns_centers")
...
export const updateWellnessCenter = async (
  id: string,
  updates: Partial<WellnessCenter>,
) => {
  try {
    const { data, error } = await supabase
      .from("wlns_centers")
...
export const deleteWellnessCenter = async (id: string) => {
  try {
    const { error } = await supabase.from("wlns_centers").delete().eq("id", id);
...
export const getPractitionersByCenter = async (centerId: string) => {
  try {
    ...
    console.error(
      `Error fetching practitioners for center ${centerId}:`,
      error,
    );
    return [];
  }
...
export const createPractitioner = async (
  practitioner: Omit<Practitioner, "id" | "created_at">,
) => {
  try {
    const { data, error } = await supabase
      .from("wlns_practitioners")
...
export const createClient = async (
  client: Omit<Client, "id" | "created_at" | "total_visits" | "total_spent">,
) => {
  try {
    const { data, error } = await supabase
      .from("wlns_clients")
  ...
  return [
    {
      ...
      description:
        "A luxury day spa offering a variety of treatments to rejuvenate both body and mind.",
      business_hours: {
    ...
    },
    {
      ...
      description:
        "A peaceful studio dedicated to mindfulness and meditation practices.",
      business_hours: {
    ...
    },
    {
      ...
      description:
        "Combining yoga and fitness for a holistic approach to wellness.",
      business_hours: {
    ...
    },
    {
      ...
      description:
        "A secluded retreat center offering immersive wellness experiences in nature.",
      business_hours: {
    ...
    },
    {
      ...
      description:
        "An integrative center combining modern medicine with traditional healing practices.",
      business_hours: {
  ...
  return [
    {
      ...
      description:
        "A gentle full body massage using long strokes to improve circulation and relaxation.",
      duration: 60,
      price: 95,
      category: "Massage",
      status: "active",
    ...
    },
    {
      ...
      description:
        "Focused massage using firm pressure to release chronic muscle tension.",
      duration: 60,
      price: 115,
      category: "Massage",
      status: "active",
    ...
    },
    {
      ...
      name: "Acupuncture",
      description:
        "Traditional Chinese medicine treatment to balance energy flow in the body.",
      duration: 90,
      price: 130,
    ...
    },
    {
      ...
      description:
        "Comprehensive wellness experience including massage, facial, and yoga class.",
      duration: 180,
      price: 225,
      category: "Packages",
      status: "active",
  ...
  return [
    {
      ...
      gender: "female",
      notes:
        "Prefers Sarah for massages. Sensitive skin, use hypoallergenic products.",
