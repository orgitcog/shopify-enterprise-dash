/*
  ...
  1. New Tables
    - `user_profiles`: Stores user information with preferences and settings
    - `stores`: Shopify store connections and metrics
    - `shopify_connections`: Authentication and connection details for Shopify stores
    - `order_summary`: Aggregated data from store orders
  
  2. Security
    - Enable RLS on all tables
    - Add proper access policies for authenticated users
