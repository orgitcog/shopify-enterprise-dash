...
-- Stores
CREATE POLICY IF NOT EXISTS "Users can create stores" 
  ON public.stores FOR INSERT 
  TO authenticated
  WITH CHECK (owner_id = auth.uid());

CREATE POLICY IF NOT EXISTS "Users can read stores they own" 
...
-- Order Summary
CREATE POLICY IF NOT EXISTS "Users can view related order summaries" 
...
CREATE POLICY IF NOT EXISTS "Users can create related order summaries" 
...
-- Webcontainers
CREATE POLICY IF NOT EXISTS "Users can view their containers" 
  ON public.webcontainers FOR SELECT 
  TO authenticated 
  USING (true);

CREATE POLICY IF NOT EXISTS "Users can manage their containers" 
  ON public.webcontainers FOR ALL
  TO authenticated 
  USING (true);

CREATE POLICY IF NOT EXISTS "Users can view container nesting" 
  ON public.webcontainer_nesting FOR SELECT 
  TO authenticated 
  USING (true);

CREATE POLICY IF NOT EXISTS "Users can manage container nesting" 
  ON public.webcontainer_nesting FOR ALL
  TO authenticated 
  USING (true);

CREATE POLICY IF NOT EXISTS "Users can view container metrics" 
  ON public.webcontainer_metrics FOR SELECT 
  TO authenticated 
  USING (true);

CREATE POLICY IF NOT EXISTS "Users can record container metrics" 
  ON public.webcontainer_metrics FOR INSERT
  TO authenticated 
  WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Users can view container messages" 
  ON public.webcontainer_messages FOR SELECT 
  TO authenticated 
  USING (true);

CREATE POLICY IF NOT EXISTS "Users can send container messages" 
