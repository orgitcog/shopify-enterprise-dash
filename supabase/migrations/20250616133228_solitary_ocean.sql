/*
  # Comprehensive database setup with RLS policies
  ...
  1. Tables
    ...
    - shopify_connections
    - order_summary
    - webcontainers and related tables
  ...
  3. RLS Policies
    ...
    - Conditional creation of policies to avoid duplicates
...
-- Use PL/pgSQL DO blocks to conditionally create policies
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE polname = 'Users can read their own profiles' AND polrelid = 'public.user_profiles'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can update their own profiles' AND polrelid = 'public.user_profiles'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can create stores' AND polrelid = 'public.stores'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can read stores they own' AND polrelid = 'public.stores'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can update their own stores' AND polrelid = 'public.stores'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can delete their own stores' AND polrelid = 'public.stores'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can read roles' AND polrelid = 'public.roles'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can read their own roles' AND polrelid = 'public.user_roles'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can create their own connections' AND polrelid = 'public.shopify_connections'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can view their own connections' AND polrelid = 'public.shopify_connections'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can update their own connections' AND polrelid = 'public.shopify_connections'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can delete their own connections' AND polrelid = 'public.shopify_connections'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can view related order summaries' AND polrelid = 'public.order_summary'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can create related order summaries' AND polrelid = 'public.order_summary'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can view their containers' AND polrelid = 'public.webcontainers'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can manage their containers' AND polrelid = 'public.webcontainers'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can view container nesting' AND polrelid = 'public.webcontainer_nesting'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can manage container nesting' AND polrelid = 'public.webcontainer_nesting'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can view container metrics' AND polrelid = 'public.webcontainer_metrics'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can record container metrics' AND polrelid = 'public.webcontainer_metrics'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can view container messages' AND polrelid = 'public.webcontainer_messages'::regclass
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_catalog.pg_policy 
    WHERE polname = 'Users can send container messages' AND polrelid = 'public.webcontainer_messages'::regclass
  ) THEN
